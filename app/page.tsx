...
export default function Home() {
  ...
  const _code = `const res = await tailtrack({namespace: "portfolio"});`;
  ...
  return (
    <main>
      ...
      <section className="mt-[18vh] flex flex-col items-center justify-center">
        <Button
          onClick={() => {
        ...
        <h1 className="text-7xl text-center leading-[120%] font-semibold">
      ...
      <div className="mt-48 mb-36 container max-w-[1000px] p-4 border border-white/20 rounded-lg">
        <Image className=" mx-auto" src={dashboardImage} alt="dashboard" />
      </div>
      <span id="setup" />
      <section className="container max-w-[1000px] px-4 lg:px-0 mb-36 py-8 border border-white/20 rounded-lg">
        <h2 className="text-4xl font-semibold text-center mb-2">Easy setup</h2>
        ...
        <div className="mx-auto max-w-[500px] space-y-3 mb-5">
          ...
          <div className="relative">
            ...
            <pre className="bg-violet-500/20 px-[5px] py-[1px] rounded-md border border-white/10 w-fit">
              <code>{_code}</code>
            </pre>
          </div>
        </div>
      </section>
      <section className="text-center py-24 border-t border-b border-white/20">
        ...
        <p className="mb-10 opacity-70 text-lg">Start using Tail Track today</p>
        <Button size="lg">Start for free</Button>
      </section>
      <footer className="pt-24 pb-10 text-center">
        <p className="mb-1">
          Created by{" "}
          <Link
